...
int test_CNC(State *state, State *expected_state)
{
    ...
    state->memory[0] = 0xd4; // CNC 0x5511
    state->memory[1] = 0x11;
    state->memory[2] = 0x55;
    ...
    state->memory[3] = 0xd4; // CNC 0x5511
    state->memory[4] = 0x11;
    state->memory[5] = 0x55;
    state->conditions.carry = 0;
    state->sp = 0xcccf;
...
int main(int argc, char *argv[])
{
    ...
    switch (strtol(argv[1], NULL, 16))
    {
        ...
        case 0xdc: result = test_CC(state, expected_state); break;
//        case 0xe4: result = test_CPO(state, expected_state); break;
//        case 0xec: result = test_CPE(state, expected_state); break;
//        case 0xf4: result = test_CP(state, expected_state); break;
//        case 0xfc: result = test_CM(state, expected_state); break;
